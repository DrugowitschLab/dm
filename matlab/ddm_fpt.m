function [g1, g2] = ddm_fpt(mu, bound, delta_t, t_max)
%% [g1, g2] = ddm_fpt(mu, bound, delta_t, t_max, ...)
%
% computing the diffusion model first-passage times as described in Smith
...
% steps of delta_t. t_max is the maximum time up until which the first-passage
% time distributions are evaluated. g1 and g2 hold the probability densities of
